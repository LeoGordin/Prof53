...
public class Lesson24 {
    public static void main(String[] args) {
        ...
        System.out.println("a".matches("[abcdef]")); // любой из перечисленных символов
        ...
        System.out.println("a".matches("[^k-m]"));
...
// специальные символы
        ...
        // до 21:36
        System.out.println(
        Arrays.toString(strangeLine.split(";|\\|"))
        );
        ...
        temperature =  temperature.replaceAll("centi", "milli");
